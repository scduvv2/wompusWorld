...
class WumpusGame(object):
    ...
    def go_dir(self, Dir):
       ...
       if   (Dir == "N"): NewPos = self.player_pos - 5
       elif (Dir == "S"): NewPos = self.player_pos + 5
       elif (Dir == "E"): NewPos = self.player_pos + 1
       elif (Dir == "W"): NewPos = self.player_pos - 1

       # Handle the odd corner cases.
       # North out of 1
